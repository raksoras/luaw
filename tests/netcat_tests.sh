...
#(echo -ne $REQ1; sleep $SLEEP1; echo -ne $REQ2; sleep $SLEEP2; echo -ne $REQ3; sleep $SLEEP3) | nc localhost 8080
#(echo -ne $REQ1; echo -ne $REQ2; echo -ne $REQ3) | nc localhost 8080
#(echo -ne $REQ1; echo -ne $REQ2; echo -ne $REQ3;) 

if [ $1 -eq 1 ]
then
	echo -ne $REQ1 | nc localhost 8080
