...
if [ $1 -eq 1 ]
then
	echo -ne $REQ1 | nc -q 10 localhost 7001
    echo "Tested single connection"
fi

if [ $1 -eq 2 ]
then
	(echo -ne $REQ1; sleep $SLEEP1; echo -ne $REQ2; sleep $SLEEP2; echo -ne $REQ3; sleep $SLEEP3) | nc -q 10 localhost 7001
    echo "Tested persistent connections"
fi

if [ $1 -eq 3 ]
then
	(echo -ne $REQ1; echo -ne $REQ2; echo -ne $REQ3) | nc -q 10 localhost 7001
